...
import com.atomscat.config.IgnoredUrlsProperties;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Value("${Atomscat.tokenExpireTime}")
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        registry.and()
                ...
                .loginPage("/rmp/common/needLogin")
                //登录请求url
                .loginProcessingUrl("/rmp/login")
                .permitAll()
                //成功处理类
                ...
                .addFilter(new JWTAuthenticationFilter(authenticationManager(), tokenRedis, tokenExpireTime));
    }
}
